...
const SPRITES_PATH := "res://assets/sprites/enemies/wolf/"
...
# Move-down/Idle: 5 frames, 257x257 each
var idle_frames := [
	Rect2i(0, 0, 257, 257),
	Rect2i(257, 0, 257, 257),
	Rect2i(514, 0, 257, 257),
	Rect2i(771, 0, 257, 257),
	Rect2i(1028, 0, 257, 257),
]

# Attack: 3 frames, 257x259 each
var attack_frames := [
	Rect2i(0, 0, 257, 259),
	Rect2i(257, 0, 257, 259),
	Rect2i(514, 0, 257, 259),
]

# Death: 3 frames, 257x259 each
var death_frames := [
	Rect2i(0, 0, 257, 259),
	Rect2i(257, 0, 257, 259),
	Rect2i(514, 0, 257, 259),
